...
const (
	...
	MORPCVersion68  int64 = 68 // PAD SPACE v1 collation key expressions
	// Native 0900 collation persistence remains disabled until all nodes and
	// recovery paths understand the durable key metadata.  Keep this activation
	// value above the latest wire version so a normal deployment fails closed.
	MORPCVersionNativeCollation int64 = 69
